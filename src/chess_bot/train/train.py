...
if __name__ == '__main__':
    ...
    weight_path = osp.join(get_chessbot_src(), 'resources/weights')
    ...
    for epoch in range(num_epochs):
        ...
        torch.save(model.state_dict(), osp.join(weight_path, f'weights/L_chess_maskrcnn_model_ep_{epoch:02}.pt'))

        # evaluate on the test dataset
        # evaluate(model, data_loader_test, device=device)


    torch.save(model.state_dict(), osp.join(weight_path, 'chess_maskrcnn_model.pt'))
